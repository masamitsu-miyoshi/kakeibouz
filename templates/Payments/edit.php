        ...
        <div class="payments form content">
            ...
            <fieldset>
                ...
                <?php
                    ...
                    echo $this->Form->control('paid_user_id', ['label' => __('👥支払人'), 'options' => $users, 'readonly' => true]);
                    ...
                    echo $this->Form->control('billed_user_id', ['label' => __('👤請求宛'), 'options' => $users, 'empty' => __('ALL')]);
                ?>
            </fieldset>
